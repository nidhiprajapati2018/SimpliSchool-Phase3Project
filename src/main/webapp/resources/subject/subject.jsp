				...
				<table class="list">
					<tr>
						<td><input type="text" name="id" id="id"
							value="${subject.getSubjectid()}" readonly /></td>
						<td><input type="text" placeholder="Subject Name" id="subject"
							name="subject" value="${subject.getSubject()}" /></td>
						<td><input type="text" placeholder="Grade" name="grade" id="grade"
							type="number" min=1 max=12 step=1 value="${subject.getGrade()}" /></td>
						<td><input type="submit"
							value="Submit" class="btn" /></td>
						<td><input type="button" class="btn" onclick="myFunction()" value="Clear" /></td>
					</tr>
				</table>
			</form>
		</c:if>
